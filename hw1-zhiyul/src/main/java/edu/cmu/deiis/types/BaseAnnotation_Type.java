...
public class BaseAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.BaseAnnotation");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "edu.cmu.deiis.types.BaseAnnotation");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "edu.cmu.deiis.types.BaseAnnotation");
