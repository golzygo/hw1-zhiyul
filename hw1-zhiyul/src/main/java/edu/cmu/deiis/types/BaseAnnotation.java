...
/** Base annotation for this sample information system.
...
public class BaseAnnotation extends Annotation {
  ...
  /** getter for source - gets The annotator who made this annotation.
   * @generated */
  public String getSource() {
    if (BaseAnnotation_Type.featOkTst && ((BaseAnnotation_Type)jcasType).casFeat_source == null)
      jcasType.jcas.throwFeatMissing("source", "edu.cmu.deiis.types.BaseAnnotation");
    return jcasType.ll_cas.ll_getStringValue(addr, ((BaseAnnotation_Type)jcasType).casFeatCode_source);}
    
  /** setter for source - sets The annotator who made this annotation. 
   * @generated */
  ...
  /** getter for confidence - gets How confident the annotator was when assigning this annotation. Range from 0 to 1, the higher the more confident.
   * @generated */
  public double getConfidence() {
    if (BaseAnnotation_Type.featOkTst && ((BaseAnnotation_Type)jcasType).casFeat_confidence == null)
      jcasType.jcas.throwFeatMissing("confidence", "edu.cmu.deiis.types.BaseAnnotation");
    return jcasType.ll_cas.ll_getDoubleValue(addr, ((BaseAnnotation_Type)jcasType).casFeatCode_confidence);}
    
  /** setter for confidence - sets How confident the annotator was when assigning this annotation. Range from 0 to 1, the higher the more confident. 
   * @generated */
